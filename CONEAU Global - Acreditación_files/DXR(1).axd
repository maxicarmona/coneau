...
.dxmVerticalMenu_Aqua
{
	...
	border: 1px Solid #AECAF0;
	padding: 0px;
	background: #E2F0FF url('/coneauglobal/DXR.axd?r=0_214-qnIN9') repeat-x top;
}
.dxmMenu_Aqua a,
...
{
	white-space: nowrap;
	background: url('/coneauglobal/DXR.axd?r=0_214-qnIN9') repeat-x top;
}
.dxmVerticalMenuItem_Aqua,
.dxmVerticalMenuItemWithImage_Aqua,
.dxmVerticalMenuItemWithPopOutImage_Aqua,
...
{
	border-style: none;
	background: url('/coneauglobal/DXR.axd?r=0_220-qnIN9') repeat-x top;
}
...
{
	color: #283B56;
	background: #FEE17B url('/coneauglobal/DXR.axd?r=0_223-qnIN9') repeat-x top;
}
.dxmVerticalMenuItemSelected_Aqua,
.dxmVerticalMenuItemSelectedWithImage_Aqua,
.dxmVerticalMenuItemSelectedWithPopOutImage_Aqua,
...
.dxmVerticalMenuLargeRtlItemSelectedWithImageWithPopOutImage_Aqua
{
	color: #283B56;
	border-style: none;
	background: #FEE385 url('/coneauglobal/DXR.axd?r=0_221-qnIN9') repeat-x top;
}
.dxmMenuLargeItemSelected_Aqua,
.dxmMenuLargeItemSelectedWithImage_Aqua,
.dxmMenuLargeItemSelectedWithPopOutImage_Aqua,
...
.dxmVerticalMenuLargeRtlItemSelectedWithImageWithPopOutImage_Aqua
{
	background: url('/coneauglobal/DXR.axd?r=0_216-qnIN9') repeat-x top;
}
...
{
	color: #283B56;
	background: #FEE899 url('/coneauglobal/DXR.axd?r=0_215-qnIN9') repeat-x top;
}
.dxmVerticalMenuItemHover_Aqua,
.dxmVerticalMenuItemHoverWithImage_Aqua,
.dxmVerticalMenuItemHoverWithPopOutImage_Aqua,
...
.dxmVerticalMenuLargeRtlItemHoverWithImageWithPopOutImage_Aqua
{
	border-style: none;
	color: #283B56;
	background: #fee17b url('/coneauglobal/DXR.axd?r=0_221-qnIN9') repeat-x top;
}
.dxmMenuLargeItemHover_Aqua,
.dxmMenuLargeItemHoverWithImage_Aqua,
.dxmMenuLargeItemHoverWithPopOutImage_Aqua,
...
.dxmVerticalMenuLargeRtlItemHoverWithImageWithPopOutImage_Aqua
{
	background: url('/coneauglobal/DXR.axd?r=0_215-qnIN9') repeat-x top;
}
...
{
	border: 1px Solid #AECAF0;
	background: #C2DCFB url('/coneauglobal/DXR.axd?r=0_217-qnIN9') repeat-x top;
	cursor: pointer;
	font-size: 0px;
	padding: 1px;
	text-align: center;
...
.dxmScrollButtonPressed_Aqua
{
	...
	background: #FFAE61 url('/coneauglobal/DXR.axd?r=0_218-qnIN9') repeat-x top;
}
...
{
	background: #FEE385 url('/coneauglobal/DXR.axd?r=0_216-qnIN9') repeat-x top;
}
...
.dxnbGroupHeader_Aqua
{
	...
	background: #F2F8FF url('/coneauglobal/DXR.axd?r=0_224-qnIN9') repeat-x top;
}
...
.dxnbLite_Aqua .dxnb-headerCollapsed 
{
	...
	cursor: pointer;
	clear: both;
	background: url('/coneauglobal/DXR.axd?r=0_224-qnIN9') repeat-x top;
}
...
.dxpDropDownButton_Aqua
{
    ...
    border: 1px solid #A3C0E8;
    line-height: 0;
    background: #DBEBFF url('/coneauglobal/DXR.axd?r=0_228-qnIN9') repeat-x top;
}
.dxpHoverDropDownButton_Aqua
{
    border: 1px solid #D6A886;
    background: #FEDC75 url('/coneauglobal/DXR.axd?r=0_230-qnIN9') repeat-x top;
}
.dxpPressedDropDownButton_Aqua
{
    border: 1px solid #CB9280;
    background: #FFB46D url('/coneauglobal/DXR.axd?r=0_231-qnIN9') repeat-x top;
}
.dxpSummary_Aqua
{
	color: #749BCA;
...
.dxpDisabledDropDownButton_Aqua
{
    ...
    background: #F5F5F5 url('/coneauglobal/DXR.axd?r=0_229-qnIN9') repeat-x top;
}
...
{
	color: #283B56;
	background: #CAE1FF url('/coneauglobal/DXR.axd?r=0_204-qnIN9') repeat-x bottom;
...
{
	color: #283B56;
	background: #E2F0FF url('/coneauglobal/DXR.axd?r=0_226-qnIN9') repeat-x;
	border-bottom: 1px Solid #A3C0E8;
...
.dxrpControlGB_Aqua .dxrpRE
{
	background: url('/coneauglobal/DXR.axd?r=0_235-qnIN9') repeat-y left top;
}
.dxrpControl_Aqua .dxrpNHTE,
.dxrpControlGB_Aqua .dxrpNHTE
{
	background: White url('/coneauglobal/DXR.axd?r=0_236-qnIN9') repeat-x left top;
}
.dxrpControl_Aqua .dxrpBE,
.dxrpControlGB_Aqua .dxrpBE
{
	background: url('/coneauglobal/DXR.axd?r=0_233-qnIN9') repeat-x left top;
}
.dxrpControl_Aqua .dxrpHeader_Aqua,
.dxrpControl_Aqua .dxrpHLE, 
.dxrpControl_Aqua .dxrpHRE
{
	background: #E0EDFF url('/coneauglobal/DXR.axd?r=0_234-qnIN9') repeat-x left top;
}
/* Disabled */
.dxrpDisabled_Aqua,
...
.dxtcTabWithTabPositionRight_Aqua
{
	...
	background: #E0EDFF url('/coneauglobal/DXR.axd?r=0_252-qnIN9') repeat-x top;
	text-align: center;
}
.dxtcTabWithTabPositionBottom_Aqua
{
	background: #E0EDFF url('/coneauglobal/DXR.axd?r=0_246-qnIN9') repeat-x bottom;
}
.dxtcTabWithTabPositionLeft_Aqua
{
	padding: 4px 10px 6px;
	background: #E0EDFF url('/coneauglobal/DXR.axd?r=0_248-qnIN9') repeat-x right top;
}
.dxtcTabWithTabPositionRight_Aqua
{
	padding: 4px 10px 6px;
	background: #E0EDFF url('/coneauglobal/DXR.axd?r=0_250-qnIN9') repeat-x left top;
}
...
.dxtcTabHoverWithTabPositionRight_Aqua
{
	...
	padding: 3px 9px 6px 10px;
	background: #FFD7A8 url('/coneauglobal/DXR.axd?r=0_253-qnIN9') repeat-x top;
}
.dxtcTabHoverWithTabPositionBottom_Aqua
{
	padding: 3px 9px 6px 10px;
	background: url('/coneauglobal/DXR.axd?r=0_247-qnIN9') repeat-x bottom;
}
.dxtcTabHoverWithTabPositionLeft_Aqua
{
	padding: 4px 10px 6px;
	background: url('/coneauglobal/DXR.axd?r=0_249-qnIN9') repeat-x left top;
}
.dxtcTabHoverWithTabPositionRight_Aqua
{
	padding: 4px 10px 6px;
	background: url('/coneauglobal/DXR.axd?r=0_251-qnIN9') repeat-x right top;
}
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_246-qnIN9');
}
...
.dxtcLite_Aqua .dxtc-tabHover
{
	background: #FFD7A8 url('/coneauglobal/DXR.axd?r=0_247-qnIN9') repeat-x top;
	border: 1px Solid #DAB364;
}
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_248-qnIN9');
	border: 1px solid #AECAF0;
}
.dxtcLite_Aqua.dxtc-left .dxtc-activeTab,
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_249-qnIN9');
}
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_250-qnIN9');
	border: 1px solid #AECAF0;
}
.dxtcLite_Aqua.dxtc-right .dxtc-tabHover
{
	background-image: url('/coneauglobal/DXR.axd?r=0_251-qnIN9');
}
.dxtcLite_Aqua.dxtc-right .dxtc-activeTab,
...
.dxucBrowseButton_Aqua
{
	...
	border: 1px solid #A3C0E8;
	background: url('/coneauglobal/DXR.axd?r=0_258-qnIN9') repeat-x;
}
...
.dxucBrowseButtonHover_Aqua
{
	color: #7E3C31;
	border: 1px solid #D6A886;
	background: #FEDC75 url('/coneauglobal/DXR.axd?r=0_260-qnIN9') repeat-x;
}
...
.dxucBrowseButtonPressed_Aqua
{
	color: #7E3C31;
	border: 1px solid #CB9280;
	background: #FFB46D url('/coneauglobal/DXR.axd?r=0_261-qnIN9') repeat-x;
}
...
{
	border: 1px Solid #A3C0E8;
	background: #efefef url('/coneauglobal/DXR.axd?r=0_262-qnIN9') repeat-x;
}
.dxucProgressBarIndicator_Aqua
{
	background: #deedff url('/coneauglobal/DXR.axd?r=0_263-qnIN9') repeat-x;
}
...
{
	border-color: #D2D2D2;
	background: #F3F3F3 url('/coneauglobal/DXR.axd?r=0_259-qnIN9') repeat-x;
}
...
.dxsplVSeparator_Aqua
{
	background-image: url('/coneauglobal/DXR.axd?r=0_240-qnIN9');
	border-top-width: 1px;
	border-bottom-width: 1px;
}
.dxsplHSeparator_Aqua
{
	background-image: url('/coneauglobal/DXR.axd?r=0_237-qnIN9');
	border-left-width: 1px;
	border-right-width: 1px;
}
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_241-qnIN9');
}
.dxsplHSeparatorHover_Aqua,
.dxsplHSeparatorButtonHover_Aqua
{
	background-image: url('/coneauglobal/DXR.axd?r=0_238-qnIN9');
}
.dxsplVSeparatorCollapsed_Aqua,
.dxsplHSeparatorCollapsed_Aqua
{
...
{
	background: url('/coneauglobal/DXR.axd?r=0_239-qnIN9') repeat;
	font-size: 0px;
	line-height: 0px;
}
.dxsplLCC
...
{
	color: #7E3C31;
	background: #FEDC75 url('/coneauglobal/DXR.axd?r=0_215-qnIN9') repeat-x center top;
	padding: 2px 10px 3px 11px;
	font-weight: normal;
	vertical-align: middle;
	border: 1px solid #D6A886;
...
.dxm-vertical.menuButtons_Aqua .dxm-item
{
	color: #2C4D79;
	border: 1px solid #A3C0E8;
	background: #E2F0FF url('/coneauglobal/DXR.axd?r=0_205-qnIN9') repeat-x top;
}
...
.dxm-vertical.menuButtons_Aqua .dxm-hovered
{
	...
	border: 1px solid #D6A886;
	background: #FEDC75 url('/coneauglobal/DXR.axd?r=0_207-qnIN9') repeat-x top!important;
}
...
.dxm-vertical.menuButtons_Aqua .dxm-disabled
{
	...
	background: #F3F3F3 url('/coneauglobal/DXR.axd?r=0_206-qnIN9') repeat-x top!important;
}
.dxm-horizontal.menuButtons_Aqua .dxm-item .dxm-popOut,
.dxm-horizontal.menuButtons_Aqua .dxm-disabled .dxm-popOut
{
...
{
	background: url('/coneauglobal/DXR.axd?r=0_256-qnIN9') repeat-y;
	vertical-align: top;
}
...
.dxtvControl_Aqua .dxtv-elb
{
	background: url('/coneauglobal/DXR.axd?r=0_254-qnIN9') no-repeat;
}
...
.dxtvControl_Aqua.dxtvRtl .dxtv-elb
{
	background-image: url('/coneauglobal/DXR.axd?r=0_255-qnIN9');
}
...
{
	width: 3px;
	background: url('/coneauglobal/DXR.axd?r=0_209-qnIN9') repeat-y right;
	border-width: 0px;
}
...
{
	background: #E2F0FF url('/coneauglobal/DXR.axd?r=0_214-qnIN9') repeat-x top left;
}
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_215-qnIN9');
}
...
{
    background-image: url('/coneauglobal/DXR.axd?r=0_210-qnIN9');
