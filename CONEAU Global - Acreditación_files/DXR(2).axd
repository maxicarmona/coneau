...
.dxgvMSDraggable .dxgvHeader_Glass,
.dxgvMSDraggable.dxgvGroupPanel_Glass
...
.dxgvHeader_Glass
{
	...
	padding: 4px 6px 5px;
	border: 1px solid #7EACB1;
	background: #b7d8dc url('/coneauglobal/DXR.axd?r=0_919-qnIN9') repeat-x top;
	overflow: hidden;
	font-weight: normal;
	text-align: left;
}
...
{
	background: #f8fbfd url('/coneauglobal/DXR.axd?r=0_917-qnIN9') repeat-x top;
	white-space: nowrap;
