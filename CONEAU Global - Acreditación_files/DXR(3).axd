...
.dxmVerticalMenu_Glass
{
	...
	padding: 0;
	background: #F0F0F0 url('/coneauglobal/DXR.axd?r=0_1040-qnIN9') repeat-x left top;
}
.dxmMenu_Glass a,
...
.dxmVerticalMenu_Glass
{
	background: #EDF3F4 url('/coneauglobal/DXR.axd?r=0_1049-qnIN9') repeat-x left top;
	padding: 1px;
}
...
{
	white-space: nowrap;
	background: url('/coneauglobal/DXR.axd?r=0_1040-qnIN9') repeat-x left top;
	border-style: none;
}
.dxmVerticalMenuItem_Glass,
.dxmVerticalMenuItemWithImage_Glass,
...
.dxmVerticalMenuRtlItemWithImageWithPopOutImage_Glass
{
	background: url('/coneauglobal/DXR.axd?r=0_1049-qnIN9') repeat-x left top;
}
.dxmMenuLargeItem_Glass,
.dxmMenuLargeItemWithImage_Glass,
.dxmMenuLargeItemWithPopOutImage_Glass,
...
.dxmVerticalMenuLargeRtlItemWithImageWithPopOutImage_Glass
{
	background: url('/coneauglobal/DXR.axd?r=0_1043-qnIN9') repeat-x left top;
}
...
{
	color: White;
	background: White url('/coneauglobal/DXR.axd?r=0_1042-qnIN9') repeat-x left top;
	border-style: none;
}
...
.dxmVerticalMenuRtlItemSelectedWithImageWithPopOutImage_Glass
{
	background: White url('/coneauglobal/DXR.axd?r=0_1051-qnIN9') repeat-x left top;
}
.dxmMenuLargeItemSelected_Glass,
.dxmMenuLargeItemSelectedWithImage_Glass,
.dxmMenuLargeItemSelectedWithPopOutImage_Glass,
...
.dxmVerticalMenuLargeRtlItemSelectedWithImageWithPopOutImage_Glass
{
	background: White url('/coneauglobal/DXR.axd?r=0_1045-qnIN9') repeat-x left top;
}
...
{
	color: black;
	background: #CBCBCB url('/coneauglobal/DXR.axd?r=0_1041-qnIN9') repeat-x left top;
	border-style: none;
}
...
.dxmVerticalMenuRtlItemHoverWithImageWithPopOutImage_Glass
{
	background: #CBCBCB url('/coneauglobal/DXR.axd?r=0_1050-qnIN9') repeat-x left top;
}
.dxmMenuLargeItemHover_Glass,
.dxmMenuLargeItemHoverWithImage_Glass,
.dxmMenuLargeItemHoverWithPopOutImage_Glass,
...
.dxmVerticalMenuLargeRtlItemHoverWithImageWithPopOutImage_Glass
{
	background: #CBCBCB url('/coneauglobal/DXR.axd?r=0_1044-qnIN9') repeat-x left top;
}
...
.dxmScrollDownButton_Glass
{
	...
	background: #F8F9FA url('/coneauglobal/DXR.axd?r=0_1046-qnIN9') repeat-x top;
	cursor: pointer;
	font-size: 0px;
	padding: 2px;
	text-align: center;
...
{
	background: #B9D9DD url('/coneauglobal/DXR.axd?r=0_1047-qnIN9') repeat-x top;
	border: 1px solid #87b8c7;
}
.dxmScrollButtonPressed_Glass
{
	background: #508BA6 url('/coneauglobal/DXR.axd?r=0_1048-qnIN9') repeat-x top;
...
{
	background: url('/coneauglobal/DXR.axd?r=0_1049-qnIN9') repeat-x top;
}
.dxmLite_Glass .dxm-horizontal,
...
{
	background: url('/coneauglobal/DXR.axd?r=0_1040-qnIN9') repeat-x top;
}

.dxmLite_Glass .dxm-main .dxm-image-t .dxm-item,
.dxmLite_Glass .dxm-main .dxm-image-b .dxm-item
{
	background-image: url('/coneauglobal/DXR.axd?r=0_1043-qnIN9');
}
...
{
	background: White url('/coneauglobal/DXR.axd?r=0_1042-qnIN9') repeat-x top;
}
...
{
	background: #CBCBCB url('/coneauglobal/DXR.axd?r=0_1041-qnIN9') repeat-x top;
}
...
{
	background: White url('/coneauglobal/DXR.axd?r=0_1051-qnIN9') repeat-x top;
}
...
{
	background: #CBCBCB url('/coneauglobal/DXR.axd?r=0_1050-qnIN9') repeat-x top;
}
...
{
	background: White url('/coneauglobal/DXR.axd?r=0_1045-qnIN9') repeat-x top;
}
.dxmLite_Glass .dxm-main .dxm-image-t .dxm-hovered,
.dxmLite_Glass .dxm-main .dxm-image-b .dxm-hovered
{
	background: #CBCBCB url('/coneauglobal/DXR.axd?r=0_1044-qnIN9') repeat-x top;
}
...
{
	color: #333333;
	background: url('/coneauglobal/DXR.axd?r=0_1052-qnIN9') repeat-x top;
...
{
	background: url('/coneauglobal/DXR.axd?r=0_1053-qnIN9') repeat-x top;
}
...
.dxpDropDownButton_Glass
{
    cursor: pointer;
    padding: 5px 4px;
    background: #45829F url('/coneauglobal/DXR.axd?r=0_1059-qnIN9') repeat-x top;
	border: 1px solid #4986a2;
    line-height: 0;
}
.dxpHoverDropDownButton_Glass
{
    background: #35acd2 url('/coneauglobal/DXR.axd?r=0_1061-qnIN9') repeat-x top;
	border: 1px Solid #4986a2;
}
.dxpPressedDropDownButton_Glass
{
    background: #35657b url('/coneauglobal/DXR.axd?r=0_1062-qnIN9') repeat-x top;
...
.dxpDisabledDropDownButton_Glass
{
    cursor: default;
    color: #93a1a4;
	background: #cdd7db url('/coneauglobal/DXR.axd?r=0_1060-qnIN9') repeat-x left top;
	border-color: #c2c3c4;
}
...
.dxpcFooter_Glass
{
	color: #175B89;
	border-top-style: none;
	background: #D3E6F3 url('/coneauglobal/DXR.axd?r=0_1056-qnIN9') repeat-x top;
}
...
.dxpcHeader_Glass
{
	color: #5A5A5A;
	border-bottom: 1px solid #D5D5D5;
	background: url('/coneauglobal/DXR.axd?r=0_1057-qnIN9') repeat-x top;
}
...
.dxrpControlGB_Glass .dxrpcontent
{
	background: #EBF2F4 url('/coneauglobal/DXR.axd?r=0_1064-qnIN9') repeat-x left bottom;
}
.dxrpControl_Glass .dxrpLE,
.dxrpControl_Glass .dxrpRE,
.dxrpControlGB_Glass .dxrpLE,
.dxrpControlGB_Glass .dxrpRE
{
	background: #EBF2F4 url('/coneauglobal/DXR.axd?r=0_1068-qnIN9') repeat-x left bottom;
}
.dxrpControl_Glass .dxrpHeader_Glass
{
	background: White url('/coneauglobal/DXR.axd?r=0_1065-qnIN9') repeat-x left bottom;
}
.dxrpControl_Glass .dxrpHLE
{
	background: White url('/coneauglobal/DXR.axd?r=0_1066-qnIN9') repeat-x left bottom;
}
.dxrpControl_Glass .dxrpHRE
{
	background: White url('/coneauglobal/DXR.axd?r=0_1067-qnIN9') repeat-x left bottom;
}
/* Disabled */
.dxrpDisabled_Glass,
...
.dxsmLevel0Categorized_Glass
{
	...
	padding: 3px 7px 4px;
	border: 1px Solid #D5D5D5;
	background: url('/coneauglobal/DXR.axd?r=0_1069-qnIN9') repeat-x top;
}
...
.dxtcActiveTab_Glass
{
	background: #4986a2 url('/coneauglobal/DXR.axd?r=0_1079-qnIN9') repeat-x top;
}
.dxtcActiveTabWithTabPositionBottom_Glass
{
	background: #94b8cc url('/coneauglobal/DXR.axd?r=0_1080-qnIN9') repeat-x bottom;
}
.dxtcActiveTabWithTabPositionLeft_Glass,
.dxtcActiveTabWithTabPositionRight_Glass
{
...
.dxtcTab_Glass 
{
	background: #F1F2F4 url('/coneauglobal/DXR.axd?r=0_1088-qnIN9') repeat-x top;
	border-bottom-style: none;
}
.dxtcTabWithTabPositionBottom_Glass
{
	background: #FFFFFF url('/coneauglobal/DXR.axd?r=0_1089-qnIN9') repeat-x bottom;
	border-top-style: none;
}
.dxtcTabWithTabPositionLeft_Glass,
.dxtcTabWithTabPositionRight_Glass
...
{
	background: #C0DDE0 url('/coneauglobal/DXR.axd?r=0_1082-qnIN9') repeat-x top;
}
.dxtcTabHoverWithTabPositionBottom_Glass
{
	background: #EEF5F7 url('/coneauglobal/DXR.axd?r=0_1083-qnIN9') repeat-x bottom;
}
...
.dxtcPageContent_Glass
{
	background: #EDF3F4 url('/coneauglobal/DXR.axd?r=0_1054-qnIN9') repeat-x top;
}
.dxtcPageContentWithTabPositionBottom_Glass
{
	background: #EDF3F4 url('/coneauglobal/DXR.axd?r=0_1055-qnIN9') repeat-x bottom;
}
.dxtcPageContentWithoutTabs_Glass
{
}
...
{
	background: url('/coneauglobal/DXR.axd?r=0_1081-qnIN9') repeat-x top;
	height: 5px;
	vertical-align: top;
}
/* Scrolling */
...
{
	border: 1px solid #4986A2;
	background: #46819E url('/coneauglobal/DXR.axd?r=0_1084-qnIN9') repeat-x;
	cursor: pointer;
	text-align: center;
	padding: 5px 6px;
}
.dxtcScrollButtonHover_Glass
{
	...
	background: #74BCDB url('/coneauglobal/DXR.axd?r=0_1086-qnIN9') repeat-x;
}
.dxtcScrollButtonPressed_Glass
{
	border: 1px solid #7DACC2;
	background: #86B5C9 url('/coneauglobal/DXR.axd?r=0_1087-qnIN9') repeat-x;
}
.dxtcScrollButtonDisabled_Glass
{
	cursor: default;
	border-color: #C0C0C0;
	background: #C7C7C7 url('/coneauglobal/DXR.axd?r=0_1085-qnIN9') repeat-x;
}
/* Misc */
...
.dxtiGroupHeaderText_Glass
{
	...
	background: url('/coneauglobal/DXR.axd?r=0_1090-qnIN9') repeat-x top;
}
...
.dxucBrowseButton_Glass
{
	...
	background: #DADFE0 url('/coneauglobal/DXR.axd?r=0_1095-qnIN9') repeat-x;
}
...
{
	border-color: #71ACB4;
	background: #B5D7DB url('/coneauglobal/DXR.axd?r=0_1096-qnIN9') repeat-x;
}
.dxucBrowseButtonPressed_Glass
{
	border-color: #71ACB4;
	background: #9ABDC1 url('/coneauglobal/DXR.axd?r=0_1097-qnIN9') repeat-x;
}
...
{
	border: 1px Solid #4986a2;
	background: #C6E0E4 url('/coneauglobal/DXR.axd?r=0_1098-qnIN9') repeat-x;
}
.dxucProgressBarIndicator_Glass
{
	background: #4986a2 url('/coneauglobal/DXR.axd?r=0_1099-qnIN9') repeat-x;
}
...
.dxsplVSeparator_Glass
{
	background-image: url('/coneauglobal/DXR.axd?r=0_1073-qnIN9');
	border-top-width: 1px;
	border-bottom-width: 1px;
}
.dxsplHSeparator_Glass
{
	background-image: url('/coneauglobal/DXR.axd?r=0_1070-qnIN9');
	border-left-width: 1px;
	border-right-width: 1px;
}
...
{
	background-image: url('/coneauglobal/DXR.axd?r=0_1074-qnIN9');
}
.dxsplHSeparatorHover_Glass,
.dxsplHSeparatorButtonHover_Glass
{
	background-image: url('/coneauglobal/DXR.axd?r=0_1071-qnIN9');
}
.dxsplVSeparatorCollapsed_Glass,
.dxsplHSeparatorCollapsed_Glass
{
...
{
	background: url('/coneauglobal/DXR.axd?r=0_1072-qnIN9') repeat;
	font-size: 0px;
	line-height: 0px;
}
.dxsplLCC
...
.menuButtons_Glass .dxmVerticalMenuLargeItemWithImageWithPopOutImage_Glass
{
	font-weight: normal;
	vertical-align: middle;
	background: #DADFE0 url('/coneauglobal/DXR.axd?r=0_1034-qnIN9') repeat-x top;
...
{
	background: #B5D7DB url('/coneauglobal/DXR.axd?r=0_1035-qnIN9') repeat-x top;
	padding: 2px 10px 3px 11px;
	font-weight: normal;
	vertical-align: middle;
...
.menuButtons_Glass.dxm-vertical .dxm-hovered
{
	...
	border: 1px solid #71ACB4;
	background: #B5D7DB url('/coneauglobal/DXR.axd?r=0_1035-qnIN9') repeat-x top!important;
}
...
{
	background: url('/coneauglobal/DXR.axd?r=0_1093-qnIN9') repeat-y;
	vertical-align: top;
}
...
.dxtvControl_Glass .dxtv-elb
{
	background: url('/coneauglobal/DXR.axd?r=0_1091-qnIN9') no-repeat;
}
...
.dxtvControl_Glass.dxtvRtl .dxtv-elb
{
	background-image: url('/coneauglobal/DXR.axd?r=0_1092-qnIN9');
}
...
{
	width: 3px;
	background: url('/coneauglobal/DXR.axd?r=0_1037-qnIN9') repeat-y right;
	border-width: 0px;
}
...
{
	background: #F2F2F7 url('/coneauglobal/DXR.axd?r=0_1056-qnIN9') repeat-x top left;
}
...
{
    background-image: url('/coneauglobal/DXR.axd?r=0_1038-qnIN9');
